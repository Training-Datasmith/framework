...
interface Container extends Container_Interface
{
    /**
     * {@inheritdoc}
     *
     ...
     * @return void
     */
    public function scoped_if($abstract, $concrete = null);
    /**
     ...
     * @return void
     */
    public function add_contextual_binding($concrete, $abstract, $implementation);
    /**
     ...
     * @return void
     */
    public function before_resolving($abstract, ?Closure $callback = null);
    /**
