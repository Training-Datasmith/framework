...
class MigrationServiceProvider extends ServiceProvider implements DeferrableProvider
{
    ...
    {
        $this->app->singleton('migration.repository', function (array $app): \Illuminate\Database\Migrations\DatabaseMigrationRepository {
    ...
    {
        $this->app->singleton(MigrateMakeCommand::class, function (array $app): \Illuminate\Database\Console\Migrations\MigrateMakeCommand {
