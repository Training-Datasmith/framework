...
class Number
{
     ...
     * @return string
     */
    public static function ordinal(int|float $number, ?string $locale = null): string|false
    {
        static::ensureIntlExtensionIsInstalled();
     ...
     * @return string
     */
    public static function spellOrdinal(int|float $number, ?string $locale = null): string|false
    {
        static::ensureIntlExtensionIsInstalled();
     ...
     * @return int|float
     */
    public static function trim(int|float $number): mixed
    {
