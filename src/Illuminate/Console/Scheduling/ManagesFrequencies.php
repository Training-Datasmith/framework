...
trait Manages_Frequencies
{
    ...
    {
        [$now, $start_time, $end_time] = [Carbon::now($this->timezone), Carbon::parse($start_time, $this->timezone), Carbon::parse($end_time, $this->timezone)];
        if ($end_time->less_than($start_time)) {
            if ($start_time->greater_than($now)) {
                $start_time = $start_time->sub_day(1);
            } else {
                $end_time = $end_time->add_day(1);
            }
        }
    ...
    {
        return $this->splice_into_position(1, '*/30');
    }
    /**
    ...
    {
        return $this->hour_based_schedule($offset, '*');
    }
    /**
    ...
    {
        return $this->hour_based_schedule($offset, '1-23/2');
    }
    /**
    ...
    {
        return $this->hour_based_schedule($offset, '*/2');
    }
    /**
    ...
    {
        return $this->hour_based_schedule($offset, '*/3');
    }
    /**
    ...
    {
        return $this->hour_based_schedule($offset, '*/4');
    }
    /**
    ...
    {
        return $this->hour_based_schedule($offset, '*/6');
    }
    /**
    ...
    {
        return $this->hour_based_schedule(0, 0);
    }
    /**
    ...
    public function daily_at($time)
    {
        ...
        return $this->hour_based_schedule(count($segments) >= 2 ? (int) $segments[1] : '0', (int) $segments[0]);
    }
    /**
    ...
    {
        $hours = $first . ',' . $second;
        return $this->hour_based_schedule($offset, $hours);
    }
    /**
     ...
     * @return $this
     */
    protected function hour_based_schedule($minutes, $hours)
    {
        $minutes = is_array($minutes) ? implode(',', $minutes) : $minutes;
        $hours = is_array($hours) ? implode(',', $hours) : $hours;
        return $this->splice_into_position(1, $minutes)->splice_into_position(2, $hours);
    }
    /**
    ...
    {
        return $this->splice_into_position(1, 0)->splice_into_position(2, 0)->splice_into_position(5, 0);
    }
    /**
    ...
    {
        return $this->splice_into_position(1, 0)->splice_into_position(2, 0)->splice_into_position(3, 1);
    }
    /**
    ...
    {
        $this->daily_at($time);
        return $this->splice_into_position(3, $day_of_month);
    }
    /**
    ...
    public function twice_monthly($first = 1, $second = 16, $time = '0:0')
    {
        ...
        $this->daily_at($time);
        return $this->splice_into_position(3, $days_of_month);
    }
    /**
    ...
    {
        $this->daily_at($time);
        return $this->splice_into_position(3, Carbon::now()->end_of_month()->day);
    }
    /**
     ...
     * @return $this
     */
    public function days_of_month(...$days)
    {
        $days = count($days) === 1 && is_array($days[0]) ? $days[0] : $days;
        $this->daily_at('0:0');
        return $this->splice_into_position(3, implode(',', $days));
    }
    /**
    ...
    {
        return $this->splice_into_position(1, 0)->splice_into_position(2, 0)->splice_into_position(3, 1)->splice_into_position(4, '1-12/3');
    }
    /**
     ...
     * @return $this
     */
    public function quarterly_on($day_of_quarter = 1, $time = '0:0')
    {
        $this->daily_at($time);
        return $this->splice_into_position(3, $day_of_quarter)->splice_into_position(4, '1-12/3');
    }
    /**
    ...
    {
        return $this->splice_into_position(1, 0)->splice_into_position(2, 0)->splice_into_position(3, 1)->splice_into_position(4, 1);
    }
    /**
    ...
    {
        $this->daily_at($time);
        return $this->splice_into_position(3, $day_of_month)->splice_into_position(4, $month);
    }
    /**
     ...
     * @return $this
     */
    protected function splice_into_position($position, $value)
    {
