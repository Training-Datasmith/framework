...
class RoutingServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->singleton('url', function ($app): \Illuminate\Routing\UrlGenerator {
        ...
        $this->app->extend('url', function (UrlGeneratorContract $url, $app): \Illuminate\Contracts\Routing\UrlGenerator {
            ...
            $app->rebinding('routes', function (array $app, $routes): void {
    ...
    {
        return function (array $app, $request): void {
    ...
    {
        $this->app->singleton('redirect', function (array $app): \Illuminate\Routing\Redirector {
