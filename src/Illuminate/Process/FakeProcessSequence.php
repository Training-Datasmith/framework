...
class FakeProcessSequence
{
     ...
     * @return $this
     */
    public function push(ProcessResultContract|FakeProcessDescription|array|string $process): static
    {
     ...
     * @return $this
     */
    public function whenEmpty(ProcessResultContract|FakeProcessDescription|array|string $process): static
    {
     ...
     */
    protected function toProcessResult(ProcessResultContract|FakeProcessDescription|array|string $process): \Illuminate\Contracts\Process\ProcessResult|\Illuminate\Process\FakeProcessDescription
    {
